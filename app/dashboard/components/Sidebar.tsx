    ...
    <aside className="hidden md:flex w-60 h-screen sticky top-0 self-start flex-col bg-white border-r border-gray-200 shrink-0 z-20">
      <div className="px-5 py-4 border-b border-gray-200 shrink-0">
        <Link href="/dashboard" className="flex items-center gap-2.5">
          <div className="w-7 h-7 rounded-md bg-[#147a67] text-white flex items-center justify-center shrink-0">
            <svg
              className="w-4 h-4"
              fill="none"
              stroke="currentColor"
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400">Operations System</p>
          </div>
        </Link>
      </div>
      ...
      <div className="border-t border-gray-200 p-4 shrink-0 bg-white">
        ...
        <p className="text-xs text-[#147a67] font-medium mt-0.5">{user.role}</p>
